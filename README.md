...
Bem lembrado! A troca para o Supabase é um diferencial importante, pois traz mais estabilidade e performance para o banco de dados PostgreSQL.

Aqui está o README.md atualizado, refletindo essa mudança na Tech Stack e nos créditos finais:
...
npm install
Configure as Variáveis de Ambiente: Crie um arquivo .env na raiz do projeto com as chaves do Supabase e Telegram:
